...
u4Byte	GLCoexVerDate8812a2Ant=20151028;
u4Byte	GLCoexVer8812a2Ant=0x3a;
//fix 8812AE+8761AU, xtal off as wifi disable
//fine tune coex. parameter
//============================================================
...
VOID
EXhalbtc8812a2ant_PTAOffOnNotify(
	IN	PBTC_COEXIST			pBtCoexist,
	IN	u1Byte			BTstatus 
	)
{
